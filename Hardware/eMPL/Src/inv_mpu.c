...
#define i2c_write(daddr, addr, len, buf) \
  GW_I2C_Write_Data(daddr, addr, buf, len)
#define i2c_read(daddr, addr, len, buf) GW_I2C_Read_Data(daddr, addr, buf, len)
...
const struct hw_s hw = {.addr = 0x68,  // TODO 0xAF ???
                        .max_fifo = 1024,
                        .num_reg = 118,
                        .temp_sens = 340,
                        .temp_offset = -521,
